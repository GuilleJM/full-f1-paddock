...
try {
    ...
    circuito.establecerCondicionesClimaticas('humedo', 25, 50);
    ...
    circuito.agregarCurva('Curva 3', 80, 'alta');

    // Pruebas de circuito
    console.log(circuito.condicionesClimaticas);
    console.log(circuito.curvas);
    console.log(circuito.zonasDRS);
    console.log(circuito.esDesafiante());
    ...
    // Pruebas de Escudería
    console.log(escuderia1.invertirEnDesarrollo('motor', 50000000));
    console.log(escuderia1.actualizarEstadisticas("victoria", 5));
    console.log(escuderia1.actualizarEstadisticas("podio", 4));
    console.log(escuderia1.actualizarEstadisticas("vueltaRapida", 2));

    console.log(escuderia1.obtenerEstadisticas().desarrollo);
    console.log(escuderia1.obtenerEstadisticas().rendimiento);
    console.log(escuderia1.obtenerEstadisticas().puntosCampeonato);
    console.log(escuderia1.obtenerEstadisticas().presupuesto);
    ...
    console.log(estrategiaFerrari.esOptima());
    console.log(estrategiaFerrari.obtenerSiguienteParada());
    console.log(estrategiaFerrari.registrarParada(2.5));
    console.log(estrategiaFerrari.obtenerSiguienteParada());
    console.log(estrategiaFerrari.registrarParada(5.5));
    ...
    console.log(circuito.obtenerEstadisticasCircuito().recordVuelta);
